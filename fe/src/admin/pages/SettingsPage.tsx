...
const NavItem = styled.button<{ $active: boolean }>`
  ...
  padding: 11px 24px;
  background: ${({ $active }) =>
    $active ? t.colors.surfaceAlt : "transparent"};
  color: ${({ $active }) =>
        ...
        <ContentPanel>
          ...
          {active === "overview" && (
            <>
              ...
              <TabDesc>
                Welcome to Project Settings. Use the navigation on the left to
                configure your store information, notifications, shipping, email
                setup, analytics, security policies, customer management, and
                the admin panel theme.
              </TabDesc>
              <div
                style={{
                  display: "grid",
                ...
                {[
                  {
                    id: "store",
                    label: "Store Info",
                    desc: "Name, address, social links and SEO",
                  },
                  {
                    id: "notification",
                    label: "Notification",
                  ...
                  },
                  {
                    id: "shipping",
                    label: "Shipping",
                    desc: "Rates, zones and processing time",
                  },
                  {
                    id: "email",
                    label: "Email",
                    desc: "SMTP credentials and sender details",
                  },
                  {
                    id: "analytics",
                    label: "Analytics",
                    desc: "Tracking IDs and reporting setup",
                  },
                  {
                    id: "security",
                    label: "Security",
                    desc: "2FA, sessions and rate limiting",
                  },
                  {
                    id: "customers",
                    label: "Customers",
                    desc: "Registration and account policies",
                  },
                  {
                    id: "theme",
                    label: "Theme",
                    desc: "Fonts and display scale",
                  },
                ].map((item) => (
                  <OverviewCard
                    key={item.id}
          ...
          {active === "store" && (
            <>
              ...
              <TabDesc>
                Manage your store's basic information, contact details, social
                links and SEO metadata.
              </TabDesc>
              {loading && (
                <p style={{ color: t.colors.textMuted, marginBottom: 16 }}>
                  Loading…
                </p>
              )}
              ...
              <FormGrid $cols={2} style={{ marginBottom: 8 }}>
                <FormGroup>
                  ...
                  <AdminInput
                    value={form.siteName}
                    onChange={upd("siteName")}
                    placeholder="Vegefoods"
                  />
                </FormGroup>
                <FormGroup>
                  ...
                  <AdminInput
                    ...
                    value={form.email}
                    onChange={upd("email")}
                    placeholder="admin@vegefoods.com"
                  />
                </FormGroup>
                <FormGroup>
          ...
          {active === "notification" && (
            <>
              ...
              <TabDesc>
                Choose which events trigger email and in-app notifications for
                your admin account.
              </TabDesc>
              {[
                {
                  k: "notifNewOrder" as keyof SettingsForm,
                  label: "New Orders",
                  sub: "Get notified when a customer places an order",
                },
                {
                  k: "notifLowStock" as keyof SettingsForm,
                  label: "Low Stock Alerts",
                  sub: "Alert when product stock drops below 10 units",
                },
                {
                  k: "notifOrderShipped" as keyof SettingsForm,
                  label: "Order Shipped",
                  sub: "Notify when an order status changes to shipped",
                },
                {
                  k: "notifNewUser" as keyof SettingsForm,
                  label: "New Registrations",
                  sub: "Notify when a new user registers",
                },
                {
                  k: "notifNewContact" as keyof SettingsForm,
                  label: "New Contact Messages",
                  sub: "Notify when a contact form is submitted",
                },
                {
                  k: "notifNewsletter" as keyof SettingsForm,
                  label: "Newsletter Subscribers",
                  sub: "Notify when someone subscribes to the newsletter",
                },
              ].map(({ k, label, sub }) => (
                <ToggleRow key={k}>
                  <div>
          ...
          {active === "shipping" && (
            <>
              ...
              <TabDesc>
                Configure shipping rates, processing time and delivery zones for
                your store.
              </TabDesc>
              <SLabel>Rates</SLabel>
              <FormGrid $cols={2} style={{ marginBottom: 8 }}>
                <FormGroup>
                  ...
                  <AdminInput
                    ...
                    onChange={upd("shippingThreshold")}
                  />
                </FormGroup>
                <FormGroup>
              ...
              <FormGrid $cols={2} style={{ marginBottom: 8 }}>
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.processingTime ?? "same-day"}
                    onChange={(val) =>
                      upd("processingTime")({ target: { value: val } } as any)
                    }
                    options={[
                ...
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.deliveryEstimate ?? "1-3"}
                    onChange={(val) =>
                      upd("deliveryEstimate")({ target: { value: val } } as any)
                    }
                    options={[
              ...
              <FormGrid $cols={1}>
                <FormGroup>
                  <FormLabel>Shipping Zones (comma-separated)</FormLabel>
                  <AdminInput
                    value={form.shippingZones}
                    onChange={upd("shippingZones")}
                  />
                </FormGroup>
              </FormGrid>
              <SaveBtn />
          ...
          {active === "email" && (
            <>
              ...
              <TabDesc>
                Configure SMTP credentials for sending transactional emails.
                These settings are stored in the database — no need to set
                environment variables. Click <strong>Test Email</strong> to
                verify your credentials after saving.
              </TabDesc>
              ...
              <FormGrid $cols={2}>
                ...
                <FormGroup>
                  ...
                  <AdminInput
                    ...
                    onChange={upd("mailFromEmail")}
                    placeholder="noreply@vegefoods.com"
                  />
                </FormGroup>
              </FormGrid>
              <div
                style={{
                  ...
                  padding: "12px 16px",
                  background: "#f9fdf3",
                  border: "1px solid #d4edbb",
                  borderRadius: 8,
                  fontSize: "0.8125rem",
                  color: "#555",
                }}
              >
                💡 <strong>Gmail tip:</strong> Use an App Password (not your
                regular password). Go to Google Account → Security → 2-Step
          ...
          {active === "analytics" && (
            <>
              ...
              <TabDesc>
                Connect analytics and tracking tools to monitor your store
              ...
              <FormGrid $cols={2}>
                <FormGroup>
                  ...
                  <AdminInput
                    ...
                    onChange={upd("fbPixelId")}
                    placeholder="123456789012345"
                  />
                </FormGroup>
                <FormGroup>
                  <FormLabel>Meta Conversions API Token</FormLabel>
                  <AdminInput
                    value={form.fbConvToken}
                    onChange={upd("fbConvToken")}
                    placeholder="EAA…"
                  />
                </FormGroup>
              </FormGrid>
          ...
          {active === "security" && (
            <>
              ...
              <TabDesc>
                Manage authentication rules, session policies and API access
                controls for the admin panel.
              </TabDesc>
              {[
                {
                  k: "secTwoFactor" as keyof SettingsForm,
                  label: "Two-Factor Authentication",
                  sub: "Require 2FA for all admin logins",
                },
                {
                  k: "secSessionTimeout" as keyof SettingsForm,
                  label: "Session Timeout",
                  sub: "Auto-logout after 60 minutes of inactivity",
                },
                {
                  k: "secRateLimit" as keyof SettingsForm,
                  label: "API Rate Limiting",
                  sub: "Limit API requests to 100/minute per IP",
                },
              ].map(({ k, label, sub }) => (
                <ToggleRow key={k}>
                  <div>
          ...
          {active === "customers" && (
            <>
              ...
              <TabDesc>
                Configure customer registration, account verification and
              ...
              <FormGrid $cols={2} style={{ marginBottom: 8 }}>
                <FormGroup>
                  ...
                  <AdminDropdown
                    ...
                    onChange={(val) =>
                      upd("registrationMode")({ target: { value: val } } as any)
                    }
                    options={[
                ...
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.emailVerification ?? "required"}
                    onChange={(val) =>
                      upd("emailVerification")({
                        target: { value: val },
                      } as any)
                    }
                    options={[
              ...
              <FormGrid $cols={2}>
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.guestCheckout ?? "enabled"}
                    onChange={(val) =>
                      upd("guestCheckout")({ target: { value: val } } as any)
                    }
                    options={[
                ...
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.accountDeletion ?? "self"}
                    onChange={(val) =>
                      upd("accountDeletion")({ target: { value: val } } as any)
                    }
                    options={[
                      { value: "self", label: "Customer can self-delete" },
          ...
          {active === "theme" && (
            <>
              ...
              <TabDesc>
                Adjust the visual appearance of the admin panel including fonts
                and layout scale.
              </TabDesc>
              ...
              <FormGrid $cols={2}>
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.themeDefault ?? "light"}
                    onChange={(val) =>
                      upd("themeDefault")({ target: { value: val } } as any)
                    }
                    options={[
                ...
                <FormGroup>
                  ...
                  <AdminDropdown
                    value={form.fontScale ?? "md"}
                    onChange={(val) =>
                      upd("fontScale")({ target: { value: val } } as any)
                    }
                    options={[
