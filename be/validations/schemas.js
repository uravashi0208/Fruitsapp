...
const updateCategorySchema = categorySchema.fork(["name"], (field) =>
  field.optional(),
);
...
const updateTestimonySchema = testimonySchema.fork(
  ["name", "message"],
  ...
  payment: Joi.object({
    ...
    cardDetails: Joi.object({
      ...
      expiryYear: Joi.string()
        ...
        .optional(),
      cardType: Joi.string()
        .valid("visa", "mastercard", "amex", "discover", "maestro", "unionpay")
        .optional(),
...
const updatePaymentStatusSchema = Joi.object({
  paymentStatus: Joi.string()
    .valid("processing", "pending", "paid", "failed", "refunded", "cancelled")
    .required(),
  transactionId: Joi.string().allow("").optional(),
  note: Joi.string().max(500).allow("").optional(),
});
